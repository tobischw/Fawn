...
public class Fawn  {
	...
	/**
	 * Main entry point that creates an instance of Fawn and starts it.
	...
	public static void main(String[] args) {
		...
		// Create a new Fawn instance, put the output stream on the system log
		Fawn program = new Fawn(inputFilePath, 7777, System.out);
	 ...
	 */
	public Fawn (String inputFilePath, int port, Appendable out) {
